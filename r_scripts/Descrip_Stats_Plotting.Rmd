...
library(tableone) # for descriptive table
```
...
print(tab1)
  ...
  #create a variables that are nonnormal (haven't checked that these aren't yet)
...
```
## Create data frames for specific data (e.g. clinical, cognitive)
