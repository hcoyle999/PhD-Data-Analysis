...
cog_data_BL <- select(COMBINED_COG_PhD, group, wtar:bvmt_recognition) # cog_df at baseline
...
# to obtain all summary statistics
 
  map_dbl(control_df, mean, na.rm=TRUE)
  
describeBy(cog_data_BL, group, mat = TRUE) 
