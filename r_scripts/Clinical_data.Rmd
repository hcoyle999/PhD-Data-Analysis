...
#notes to self when knitting rmarkdown files, all objects that are called need to have been created in this workspace
...
# 1. WTAR Clinical data (measure of premorbid intelligence)
...
```{r normality HADS, fig.width=8, fig.height=6, include=TRUE}
...
```{r SF-36 Health Q, include=FALSE}
