...
normality_testing <-"/Users/han.coyle/Documents/PHD-Data-Analysis/PHD-Data-Analysis/r_scripts/Normality_testing.Rmd"
```

```{r get raw SPSS data, include=FALSE}
## Opening my SPPS database and converting to R file
#set wd
rawdata<-"/Users/han.coyle/Documents/PHD-Data-Analysis/PHD-Data-Analysis/COMBINED_COG_PhD.sav"
...
#change levels of amnesia to labels
mtbi_df$headinjury_hx <- lut2[mtbi_df$headinjury_hx]
mtbi_df$loc <- lut2[mtbi_df$loc]
mtbi_df$amnesia <- lut3[mtbi_df$amnesia]
...
#exclude participants and create a new dataset
COMBINED_COG_PhD_clean <-subset(COMBINED_COG_PhD,!code %in% c(7, 16))

##need to create a data set that is cleaned so I don't need to do this step repeatedly, can save as r.data ## 
```
