...
%files)
path = '/Volumes/HOY_2/TMS_EEG Data/Resting_analysis_Statistics/eo_theta_BL';
group = {'Control';'TBI'};
pval = {'025'};
df = {'33'};
cond = {'high'};
...
cd('//Volumes/HOY_2/TMS_EEG Data/Resting_analysis_Statistics/');
...
wPLIname = '//Volumes/HOY_2/TMS_EEG Data/Resting_analysis_Control/connectivitymeanALL_eo.mat';
load(wPLIname);
HC=connectivitymeanALL.(Bandwidth{1,Band}).(TimeCondition{1,Time});

wPLIname = '//Volumes/HOY_2/TMS_EEG Data/Resting_analysis_TBI/connectivitymeanALL_eo.mat';
load(wPLIname);
