...
design= 1;  % 1= between groups, 2 = within groups_c 3= within groups_t
%----------------------------------%
...
WheresBNV= 'C:\Users\Public\MATLAB\EEGWORKSPACE\TOOLSHED\Connectivity_NBS\BrainNetViewer_20181219';
...
SourceDir= [datadir filesep 'SP_analysis_Statistics' filesep 'NNM_Statistics']; 
for b=1:4
   
WorkDir=[SourceDir filesep Condition{c1},'_V_',Condition{c2},'_',Group{grp1},'_V_',Group{grp2},'_',Timepoint{1,t1},'_V_',Timepoint{1,t2},'_', Bandwidth{1,b}, filesep];
mkdir(WorkDir); 
...
if design==1;
UI.design.ui=[SourceDir,filesep,'DesignMatrix_btwgrps.mat'];
DoF = 53
elseif design==2;
UI.design.ui=[SourceDir,filesep,'DesignMatrix_withingrps_c.mat'];  
DoF = 51
elseif design==3;
UI.design.ui=[SourceDir,filesep,'DesignMatrix_withingrps_t.mat'];  
DoF = 57
end
...
% Degrees of freedom.
% Unpaired t test (btw subjects), df=(n1+n2)-2.  df= (26+29)- 2 = 53
% Paired t test (within subjects), df=n-1, where n is the number of observations.
% DoF=51; 
% between subjects DOF = 53 
% within subject controls DoF = 51 
% within subject mTBI  DoF = 57
...
UI.matrices.ui=[SourceDir,filesep,Condition{c1},'_V_',Condition{c2},'_',Group{grp1},'_V_',Group{grp2},'_',Timepoint{1,t1},'_V_',Timepoint{1,t2},'_', Bandwidth{1,b} '_NNM.mat']
disp(UI.matrices.ui)
